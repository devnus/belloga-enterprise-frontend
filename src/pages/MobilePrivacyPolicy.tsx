            ...
            <div className="bg-white py-8 px-4">
              <div>
                ...
                <p className="ls2">
                  ...
                  <em className="emphasis">10</em>월{" "}
                  <em className="emphasis">12</em>부터 적용됩니다.
                </p>
                <br />
                <p className="lh6 bs4">
                  <strong>
                    ...
                    <br />
                    <em className="emphasis">
                      &lt; Devnus &gt;('http://enterprise.belloga.com/'이하
                      'Belloga')
                    </em>
                ...
                <ul className="list_indent2 mgt10">
                  ...
                  <p className="ls2">
                    ...
                    식별·인증, 서비스 부정이용 방지, 각종 고지·통지 목적으로
                    개인정보를 처리합니다.
                  </p>
                  <br />
                ...
                <p className="lh6 bs4">
                  ...
                  <br />
                  <br />① <em className="emphasis">&lt; Devnus &gt;</em>은(는)
                ...
                <ul className="list_indent2 mgt10">
                  ...
                  <li className="tt">
                    ...
                    수집.이용에 관한 동의일로부터&lt;5년&gt;까지 위 이용목적을
                    위하여 보유.이용됩니다.
                  </li>
                  <li>
                    보유근거 : 전자상거래 등에서의 소비자보호에 관한 법률보관
                    기간 5년
                  </li>
                ...
                <ul className="list_indent2 mgt10">
                  <li className="tt">1&lt; 홈페이지 회원가입 및 관리 &gt;</li>
                  <li>
                    필수항목 : 이메일, 휴대전화번호, 생년월일, 이름, 서비스 이용
                    기록
                  </li>
                </ul>
                <br />
                ...
                <em className="emphasis">
                  ...
                  <p className="ls2">
                    <em className="emphasis">
                      ...
                      <br />
                      1. 파기절차
                      <br /> &lt; Devnus &gt; 은(는) 파기 사유가 발생한
                      개인정보를 선정하고, &lt; Devnus &gt; 의 개인정보
                  ...
                  <em className="emphasis">
                    ...
                    <p className="ls2">
                      <br />
                      <br />① 정보주체는 Devnus에 대해 언제든지 개인정보
                      열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수
                      있습니다.
                    </p>
                    <p className="sub_p">
                      ② 제1항에 따른 권리 행사는Devnus에 대해 「개인정보
                      보호법」 시행령 제41조제1항에 따라 서면, 전자우편,
                      모사전송(FAX) 등을 통하여 하실 수 있으며 Devnus은(는) 이에
                      대해 지체 없이 조치하겠습니다.
                    </p>
                    <p className="sub_p">
                    ...
                    <p className="lh6 bs4">
                      <strong>
                        제9조(개인정보를 자동으로 수집하는 장치의 설치·운영 및
                        그 거부에 관한 사항)
                      </strong>
                    </p>
                    <p className="ls2">
                      <br />
                      <br />
                      Devnus 은(는) 정보주체의 이용정보를 저장하고 수시로
                    ...
                    <p className="sub_p">
                      &lt;개인정보처리자명&gt;은(는) 온라인 맞춤형 광고 등을
                      위한 행태정보를 수집·이용·제공하지 않습니다.
                    </p>
                    <br />
                    <br />
                    ...
                    <p className="sub_p mgt10">
                      <strong>
                        <em className="emphasis">
                          {" "}
                          ① <span className="colorLightBlue">Devnus</span>{" "}
                    ...
                    <ul className="list_indent2 mgt10">
                      ...
                      <li>
                        <strong>
                          <em className="emphasis">성명 :배설영</em>
                        </strong>
                      </li>
                      <li>
                        <strong>
                          <em className="emphasis">직책 :Devnus 개발/운영팀</em>
                        </strong>
                      </li>
                      <li>
                        <strong>
                          <em className="emphasis">직급 :팀원</em>
                        </strong>
                      </li>
                      <li>
                        <strong>
                          <em className="emphasis">
                            연락처 :010-8942-1688, devnus.official@gmail.com,{" "}
                          </em>
                        </strong>
                      </li>
                    </ul>
                    ...
                    <p className="sub_p">
                      <strong>
                        <em className="emphasis">
                          ② 정보주체께서는 Devnus 의 서비스(또는 사업)을
                          이용하시면서 발생한 모든 개인정보 보호 관련 문의,
                          불만처리, 피해구제 등에 관한 사항을 개인정보
                          보호책임자 및 담당부서로 문의하실 수 있습니다. Devnus
                          은(는) 정보주체의 문의에 대해 지체 없이 답변 및
                          처리해드릴 것입니다.
                        </em>
                      </strong>
                    </p>
